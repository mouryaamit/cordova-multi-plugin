 ...
 *
 */
public class OverlayCameraPreview extends SurfaceView implements SurfaceHolder.Callback {

    private static final String TAG = OverlayCameraPreview.class.getSimpleName();

    private final Camera camera;

    public OverlayCameraPreview(Context context, Camera camera) {
        super(context);
        this.camera = camera;
